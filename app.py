...
from chatbot.chatbot import predict_class
from chatbot.chatbot import get_response
from chatbot.chatbot import intents
from disease.disease_predictor import predict_disease
...
#             "restlessness","lethargy","patches_in_throat","irregular_sugar_level","cough","high_fever",
#             "sunken_eyes","breathlessness","sweating","dehydration","indigestion","headache","yellowish_skin",
#             # "dark_urine",nausea,loss_of_appetite,pain_behind_the_eyes,back_pain,constipation,abdominal_pain,
...
#             # weakness_of_one_body_side,loss_of_smell,bladder_discomfort,foul_smell_of_urine,continuous_feel_of_urine,passage_of_gases,internal_itching,
#             # toxic_look_(typhos),depression,irritability,muscle_pain,altered_sensorium,red_spots_over_body,belly_pain,abnormal_menstruation,dischromic_patches,
#             # watering_from_eyes,increased_appetite,polyuria,family_history,mucoid_sputum,rusty_sputum,lack_of_concentration,visual_disturbances,receiving_blood_transfusion,
#             # receiving_unsterile_injections,coma,stomach_bleeding,distention_of_abdomen,history_of_alcohol_consumption,fluid_overload,blood_in_sputum,prominent_veins_on_calf,
...
#         st.error(f"Predicted Disease: {disease}")
...
if st.button("Send"):
    ...
    # Save chat
    save_chat(user_message=True, bot_response=True)
